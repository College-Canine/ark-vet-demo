  ...
  const appointments = [
    {
      ...
      notes: "Patient due for vaccinations. Owner mentioned slight limping in right front leg.",
      status: "Confirmed",
      duration: 30,
      ...
      <div className="grid gap-6">
        <div>
          ...
          <div className="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <DetailItem label="Date & Time" value={format(appointment.date, "MMMM d, yyyy 'at' h:mm a")} />
            <DetailItem label="Duration" value={`${appointment.duration} minutes`} />
            <DetailItem
              label="Status"
              value={
                <Badge
        ...
        <div>
          ...
          <div className="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <DetailItem label="Created" value={format(appointment.createdAt, "MMMM d, yyyy")} />
          </div>
        </div>
      </div>
    </DetailView>
